export const translations = {
  zh: {
    ...
    settings: {
      title: '图片存储设置',
      storageLabel: '存储方式',
      base64Option: '内嵌 Base64',
      localOption: '本地文件引用',
      base64Desc: '图片数据嵌入 .md 文件，离线可用，随处可打开。',
      base64Warn: '⚠️ 图片越多文件越大，不适合图片密集型文档。',
      localDesc: '图片以相对路径（./images/...）引用，文件体积小。',
      localWarn: '⚠️ 图片须与 .md 文件同目录；在线版不支持。',
      langLabel: '界面语言', langZh: '中文', langEn: 'English',
      cancel: '取消', save: '保存',
    },
    hint: {
      title: '图片存储方式说明',
      intro: '粘贴图片时，编辑器支持三种存储方式，可在 ⚙️ 设置 中随时切换。',
      base64Title: '内嵌 Base64',
      base64Desc: '图片数据嵌入 .md 文件，离线可用，随处可打开。',
      base64Warn: '⚠️ 图片越多文件越大，不适合图片密集型文档。',
      localTitle: '本地文件引用',
      localDesc: '图片以相对路径引用，文件体积小，与 VSCode 方式一致。',
      localWarn: '⚠️ 图片须与 .md 文件同目录；在线版不支持。',
...
`,
  ...
  en: {
    ...
    settings: {
      ...
      base64Option: 'Inline Base64',
      localOption: 'Local File',
      base64Desc: 'Image data embedded in the .md file. Works offline, opens anywhere.',
      base64Warn: '⚠️ File size grows with more images. Not for image-heavy documents.',
      localDesc: 'Images referenced by relative path (./images/...). Keeps file size small.',
      localWarn: '⚠️ Images must be in the same folder as the .md file. Not supported online.',
      langLabel: 'Interface Language', langZh: '中文', langEn: 'English',
      cancel: 'Cancel', save: 'Save',
    },
    hint: {
      title: 'Image Storage Options',
      intro: 'When pasting images, three storage methods are available. Switch anytime in ⚙️ Settings.',
      base64Title: 'Inline Base64',
      base64Desc: 'Image data embedded in the .md file. Works offline, opens anywhere.',
      base64Warn: '⚠️ File size grows with more images. Not for image-heavy documents.',
      localTitle: 'Local File',
      localDesc: 'Images referenced by relative path. Small file size, same as VSCode.',
      localWarn: '⚠️ Images must be in the same folder as the .md file. Not supported online.',
...
Object.assign(translations.zh.settings, {
  r2Option: 'PokerS 链接',
  r2Desc: '图片上传后生成短链接，可在线访问，无需管理本地文件。',
  r2Warn: '⚠️ 图床不定期清理，清理前会发送公告。',
})

Object.assign(translations.en.settings, {
  r2Option: 'PokerS Link',
  r2Desc: 'Images are uploaded and inserted as short links. Accessible online, no local files needed.',
  r2Warn: '⚠️ Images are cleaned up periodically. A public notice will be posted before any cleanup.',
})

Object.assign(translations.zh.hint, {
  r2Title: 'PokerS 链接',
  r2Desc: '图片上传后自动生成短链接并插入文档，可在任何地方在线访问。',
  r2Warn: '⚠️ 图床不定期清理，清理前会发送公告，请留意。',
})

Object.assign(translations.en.hint, {
  r2Title: 'PokerS Link',
  r2Desc: 'Images are uploaded and inserted as short links — accessible online from anywhere.',
  r2Warn: '⚠️ Images are cleaned up periodically. A public notice will be posted before any cleanup.',
})
